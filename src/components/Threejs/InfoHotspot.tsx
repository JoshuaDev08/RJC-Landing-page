...
const START = new THREE.Vector3(-2, -2.5, 0);
const MID = new THREE.Vector3(-4, -4.5, 0);
const END = new THREE.Vector3(-7, -6.4, 0);
    ...
    <>
      ...
      {showCard && (
        ...
        >
          ...
          >
            <h3 className="text-warning">Tables Info</h3>
            <div className="flex flex-col gap-2 mt-2">
              <div className="mt-3 text-sm text-white space-y-1">
                <p>
                  <span className="text-gray-400">Glass:</span>{" "}
                  <span className="text-warning">{selectedGlassMaterial}</span>
                </p>

                <p>
                  <span className="text-gray-400">Base Type:</span>{" "}
                  <span className="text-warning">{selectedMaterial}</span>
                </p>
              </div>
            </div>
          </motion.div>
